<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所在地点" prop="suozaididian">
          <el-input v-model="ruleForm.suozaididian" 
              placeholder="所在地点" clearable  :readonly="ro.suozaididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所在地点" prop="suozaididian">
              <el-input v-model="ruleForm.suozaididian" 
                placeholder="所在地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../ssmhkrf8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
