<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="博文标题" prop="bowenbiaoti">
          <el-input v-model="ruleForm.bowenbiaoti" 
              placeholder="博文标题" clearable  :readonly="ro.bowenbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="博文标题" prop="bowenbiaoti">
              <el-input v-model="ruleForm.bowenbiaoti" 
                placeholder="博文标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="博文类型" prop="bowenleixing">
          <el-select v-model="ruleForm.bowenleixing" placeholder="请选择博文类型">
            <el-option
                v-for="(item,index) in bowenleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="博文类型" prop="bowenleixing">
	      <el-input v-model="ruleForm.bowenleixing"
                placeholder="博文类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../ssmhkrf8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
            ...
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.bowenxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
